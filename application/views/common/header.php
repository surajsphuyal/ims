...
<link id="style_color" href="<?= site_url('assets'); ?>/admin/layout2/css/themes/grey.css" rel="stylesheet" type="text/css"/>
...
<div class="page-header md-shadow-z-1-i navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="<?= site_url('assets'); ?>/admin/layout2/img/logo-default.png" alt="logo" class="logo-default"/>
			</a>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle" src="<?= site_url('assets'); ?>/admin/layout2/img/avatar3_small.jpg"/>
