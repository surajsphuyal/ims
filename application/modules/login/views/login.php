...
<link href="<?= site_url('assets'); ?>/admin/layout2/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
	<a href="index.html">
	<img src="<?= site_url('assets'); ?>/admin/layout2/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
